...
#define PWM_MOTOR_FORWARD_LEFT_CHANNEL 0
#define PWM_MOTOR_REVERSE_LEFT_CHANNEL 1
#define PWM_MOTOR_FORWARD_RIGHT_CHANNEL 2
#define PWM_MOTOR_REVERSE_RIGHT_CHANNEL 3
...
void setup() {
    setupPins();
    setDriveParams(
        PWM_MOTOR_FORWARD_LEFT_CHANNEL,
        PWM_MOTOR_REVERSE_LEFT_CHANNEL,
        PWM_MOTOR_FORWARD_RIGHT_CHANNEL,
        PWM_MOTOR_REVERSE_RIGHT_CHANNEL,
        ENC_LEFT_A_GPIO,
        ENC_LEFT_B_GPIO,
        ENC_RIGHT_A_GPIO,
        ENC_RIGHT_B_GPIO,
...
void loop() {
    ...
    // Until steering implemented. - min +/- 0.1m/s
...
void setupPins() {
    ...
    ledcSetup(PWM_MOTOR_FORWARD_LEFT_CHANNEL, PWM_FREQUENCY, PWM_RESOLUTION);
    ledcSetup(PWM_MOTOR_REVERSE_LEFT_CHANNEL, PWM_FREQUENCY, PWM_RESOLUTION);
    ledcAttachPin(MOTOR_FORWARD_LEFT_GPIO, PWM_MOTOR_FORWARD_LEFT_CHANNEL);
    ledcAttachPin(MOTOR_REVERSE_LEFT_GPIO, PWM_MOTOR_REVERSE_LEFT_CHANNEL);
    ledcWrite(PWM_MOTOR_FORWARD_LEFT_CHANNEL, 0);
    ledcWrite(PWM_MOTOR_REVERSE_LEFT_CHANNEL, 0);

    ledcSetup(PWM_MOTOR_FORWARD_RIGHT_CHANNEL, PWM_FREQUENCY, PWM_RESOLUTION);
